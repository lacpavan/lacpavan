...
Hands-on experience with API integration, application security, and SQL-based data analysis in large-scale production environments. Currently focused on machine learning projects in Python: predictive modeling, feature engineering, and deploying models as interactive applications.
...
**Data**
EDA · Model Evaluation · Matplotlib · Seaborn

**Tools & Cloud**
Streamlit · Git · AWS

**Exploring**
Docker · PostgreSQL · TensorFlow
